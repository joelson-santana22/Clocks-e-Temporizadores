...
const uint LED_GREEN_PIN = 11;    // Define o pino GPIO 11 para controlar o LED.
...
int64_t turn_off_callback(alarm_id_t id, void *user_data) {
    ...
    // Desliga o LED configurando o pino LED_GREEN_PIN para nível baixo.
...
int main() {
    ...
    // Configura o pino LED_GREEN_PIN (11) como saída digital.
    ...
    while (true) {
        ...
        if (gpio_get(BUTTON_PIN) == 0 && !led_active) {
            ...
            if (gpio_get(BUTTON_PIN) == 0) {
                // Liga o LED configurando o pino LED_GREEN_PIN para nível alto.
